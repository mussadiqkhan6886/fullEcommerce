            ...
            if(cartValue[item.id]>0){
                return (
                    <div key={item.id} className='flex py-2 items-center border-b border-gray-300'>
                        ...
                        <h3 className='w-[15%] pl-2'>${item.new_price}</h3>
        ...
        <div className='md:w-[40%] w-full px-10 md:px-0'>
            ...
            <div className='w-full text-[14px]'>
                ...
                <div className='flex justify-between mb-2 mt-3'>
                    ...
                    <p className='font-bold text-[16px]'>${totalAmount()}</p>
                </div>
            </div>
            <button className='bg-red-500 px-6 py-2 text-white mt-5'>PROCEED TO CHECKOUT</button>
        </div>
        <div>
